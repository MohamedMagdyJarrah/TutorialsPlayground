...
namespace {
struct qt_meta_tag_ZN11DestinationE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN11DestinationE = QtMocHelpers::stringData(
    "Destination",
    "mySlot",
    "",
    "message"
...
Q_CONSTINIT static const uint qt_meta_data_ZN11DestinationE[] = {
...
Q_CONSTINIT const QMetaObject Destination::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11DestinationE.offsetsAndSizes,
    qt_meta_data_ZN11DestinationE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11DestinationE_t,
        // Q_OBJECT / Q_GADGET
...
void *Destination::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11DestinationE.stringdata0))
